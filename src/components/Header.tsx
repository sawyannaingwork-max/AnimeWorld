...
export default function Header()
{
    ...
    return(
        <header className="h-20 relative bg-background justify-between flex items-center px-5">
            ...
            <form className={`${isOpen? "h-auto" : "h-0"} lg:h-auto overflow-hidden flex w-full lg:w-1/2 absolute top-full left-0 lg:relative px-5 lg:top-auto lg:left-auto`} action="#">
